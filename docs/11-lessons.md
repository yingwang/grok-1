...
公开资料里 xAI 没有给出明确解释，但结合创始团队背景与同期技术格局可以做出几点合理推断：

1. **创始团队背景倾向 JAX**：联合创始人 Igor Babuschkin 来自 DeepMind，而 DeepMind 内部的训练栈长期以 JAX 为主；Greg Yang 来自 Microsoft Research，µTransfer 系列论文中的实现也是基于 JAX。这些个人技术储备让团队在选型时对 JAX 有天然偏好
